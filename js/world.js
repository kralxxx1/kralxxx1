...
(function (root) {
  ...
  const THEMES = {
    ...
    pool: { wall: 'tile', floor: 'tile', ceil: 'tile', trim: null, pillar: 'tile', ambient: [0.1, 0.12, 0.13], bounce: 0.6, ceilFactor: 0.85, env: [0.6, 0.7, 0.75], envPanel: [4, 4.3, 4.6], trimH: 0 },

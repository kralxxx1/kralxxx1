...
(function (root) {
  ...
  D.chompyStand = [['cyl', 'darkMetal', 0.3, 0.35, 0.05, 16, 0, 0.025, 0], ['cyl', 'chrome', 0.02, 0.02, 1.4, 8, 0, 0.72, 0], ['cap', 'chompyFur', 0.32, 0.5, 0, 1.2, 0], ['sph', 'chompyFur', 0.5, 0, 2.0, 0, 24, 16], ['box', 'chompyDark', 0.6, 0.12, 0.05, 0, 1.95, 0.46, 0.2], ...[-0.18, 0.18].map(x => ['sph', 'chompyDark', 0.07, x, 2.2, 0.43, 10, 8])];
  // ------------------------------------------------------------ TUNNELS
